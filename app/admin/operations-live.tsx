...
import { useOperationsLive } from '../../src/hooks/useOperationsLive';
import {
  adminCancelTripApi,
...
import type { OperationalAlertRecord } from '../../src/types/adminCenter';
...
export default function OperationsLiveScreen() {
  ...
  const handleCancelTrip = useCallback((trip: TripRequest) => {
    Alert.alert(
      'Cancelar viaje',
